...
class DataToFile:
    ...
    column_names = ["x_acc", "y_acc", "z_acc", "x_gyro", "y_gyro", "z_gyro", "label_name", "label_num"]
    ...
    def write_to_csv(self, data_values: List[str]):
        ...
        # if len(set([len(labels), len(data_values)])) > 1:
...
class Connection:
    ...
    def notification_handler(self, sender: str, data_bytes: bytearray):
        # print("Received data: " + data_bytes.decode() + " Entries: " + str(len(self.data)) + "/" + str(self.dump_size))
